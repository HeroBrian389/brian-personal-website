...
export const localWritingPosts: LocalWritingPost[] = [
	{
		...
		},
		{
			type: "paragraph",
			text:
				"What makes Edge special is its capacity for experimentation. You are free to try unusual things, think in new ways, and find your tribe. Edge is ultimately what you make of it, whether that is volleyball tournaments, neuroscience research, or dinivation."
		},
		{
			type: "image",
